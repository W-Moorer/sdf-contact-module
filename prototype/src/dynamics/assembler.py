...
from .constraints import (eval_constraints, eval_constraint_jacobian,
                          eval_drive_constraints, compute_bc,
...
class DynamicsAssembler:
    ...
    def assemble(self, state, dt):
        ...
        if nc > 0 and nv > 0:
            ...
            b_c = compute_bc(self.model, state, dt)
        else:
